"""Training script for maize yield baseline model.

Supports both USA pretraining and ASEAN from-scratch training.
...
Usage:
    ...
    # ASEAN from-scratch (no transfer)
    python src/training/train.py --config experiments/configs/usa_baseline.yaml \\
        --country vnm --name vnm_scratch
"""
