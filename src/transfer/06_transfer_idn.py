"""Fine-tune USA-pretrained model on Indonesia target.
...
Usage:
    # Step 1: train USA baseline
    python src/training/05_train_usa.py --config experiments/configs/usa_baseline.yaml

    # Step 2: fine-tune on Indonesia
    python src/transfer/06_transfer_idn.py --country idn
"""
...
from src.training import evaluate, r2_score, rmse, set_seed, train_epoch
...
def main() -> None:
    ...
    parser.add_argument("--country", required=True, choices=["idn"])
